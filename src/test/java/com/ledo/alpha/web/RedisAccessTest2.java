...
import com.ledo.alpha.web.entity.msg.RedisPubBean;
import com.ledo.alpha.web.entity.msg.RedisPubMsg;
import com.ledo.alpha.websocket.redis.JedisAccess;
import com.ledo.alpha.websocket.redis.JedisAccessFactory;
 ...
 */
public class RedisAccessTest2 {

    private Logger log = LoggerFactory.getLogger(RedisAccessTest2.class);
